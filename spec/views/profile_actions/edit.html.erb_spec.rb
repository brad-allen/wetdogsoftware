...
RSpec.describe "profile_actions/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit profile_action form" do
    render

    assert_select "form[action=?][method=?]", profile_action_path(@profile_action), "post" do
