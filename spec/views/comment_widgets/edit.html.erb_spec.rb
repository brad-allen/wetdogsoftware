...
RSpec.describe "comment_widgets/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit comment_widget form" do
    render

    assert_select "form[action=?][method=?]", comment_widget_path(@comment_widget), "post" do
